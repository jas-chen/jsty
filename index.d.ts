...
declare function d(sel: string): (...args: Array<CSSDeclaration[]>) => CSSDeclaration[];

declare function media(media: string): (...args: Array<CSSDeclaration[]>) => CSSDeclaration[];
